        ...
        <div className="max-w-4xl mx-auto">
          <CreativeCard className="backdrop-blur-xl">
            <div className="text-center mb-8 sm:mb-12">
              <h3 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-portfolio-text to-portfolio-primary bg-clip-text text-transparent mb-6">
                Información de Contacto
              </h3>
              <p className="text-portfolio-neutral text-base sm:text-lg">
            ...
            <div className="grid gap-8 mb-10 sm:mb-12 md:grid-cols-2">
            ...
            <div className="text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4 sm:gap-6">
                <a
                  ...
                  className="glassmorphism hover:bg-portfolio-primary hover:text-white transition-all duration-300 card-3d p-4 rounded-xl group min-w-24"
                >
                  <Github size={32} />
                ...
                <a
                  ...
                  className="glassmorphism hover:bg-portfolio-secondary hover:text-white transition-all duration-300 card-3d p-4 rounded-xl group min-w-24"
                >
                  <Mail size={32} />
